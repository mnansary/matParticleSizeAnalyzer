function [min_width] = process_binary_segment( boundary,centroid,object_number)
    ...
    %% --line determination
    fprintf('               #: Determining point pairs that fall on the same line through Centroid! \n');
    point_list= determine_points_in_line(pos_half,pos_count,neg_half,neg_count); % pos neg
    fprintf('               #: Measuring Distance Charecterictics! \n');
